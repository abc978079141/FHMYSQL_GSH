  ...
  */    
    ...
    public boolean sendMail(String title,String content,String type,String tomail) throws Exception{   
    	...
    	//这个类主要是设置邮件   
	     ...
	     mailInfo.setUserName("978079141@qq.com");    
	     mailInfo.setPassword("yfrdjqtaediibeef");//您的邮箱密码    
	     mailInfo.setFromAddress("978079141@qq.com");    
    ...
    public static void sendEmail(String SMTP, String PORT, String EMAIL, String PAW, String toEMAIL, String TITLE, String CONTENT, String TYPE) throws Exception{ 
        ...
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setContent(CONTENT);    
	     //这个类主要来发送邮件   
	     System.out.println("sendEmail  loading.......");
    ...
    public static void main(String[] args) throws Exception{  
        ...
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setValidate(true);    
	     mailInfo.setUserName("978079141@qq.com");    
	     mailInfo.setPassword("tehzqyyslqovbbga");//您的邮箱密码    
	    // mailInfo.setPassword("gshwdd1314.");//您的邮箱密码    

	     mailInfo.setFromAddress("978079141@qq.com");    
	     mailInfo.setToAddress("1125582141@qq.com");    
